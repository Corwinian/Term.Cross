...
extern void ini_sgp4( TSatParams* this, TIniSatParams* isp, unsigned short baseYear, double baseYearTime, TCorrectionParams* cop );
extern void sgp4( double );
...
void ini_sgp4( TSatParams* this, TIniSatParams* isp, unsigned short baseYear, double baseYearTime, TCorrectionParams* cop ){
