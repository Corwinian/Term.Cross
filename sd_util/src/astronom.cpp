...
\*-------------------------------------------*/
void sunpos( double jd, double* alfa, double * delta) {
	double t;
	double dt;
	double l;
	double m;
...
\*-------------------------------------------*/
double kplreq( double tol, double m, double e ) {
	double d = 1.0;
	double ea;
