...
struct TFiltrParams {
	...
	// параметры введенные в filtr2 и специфичные для спутника
	int day_45_quadratic_filtr_flag;
	double day_45_quadratic_filtr_sigma;
	double day_45_quadratic_filtr_a0;
	double day_45_quadratic_filtr_a1;
	double day_45_quadratic_filtr_a2;

	int day_34_quadratic_filtr_flag;
	double day_34_quadratic_filtr_sigma;
	double day_34_quadratic_filtr_a0;
	double day_34_quadratic_filtr_a1;
	double day_34_quadratic_filtr_a2;

	int day_35_quadratic_filtr_flag;
	double day_35_quadratic_filtr_sigma;
	double day_35_quadratic_filtr_a0;
	double day_35_quadratic_filtr_a1;
	double day_35_quadratic_filtr_a2;

	int night_45_quadratic_filtr_flag;
	double night_45_quadratic_filtr_sigma;
	double night_45_quadratic_filtr_a0;
	double night_45_quadratic_filtr_a1;
	double night_45_quadratic_filtr_a2;

	int night_34_quadratic_filtr_flag;
	double night_34_quadratic_filtr_sigma;
	double night_34_quadratic_filtr_a0;
	double night_34_quadratic_filtr_a1;
	double night_34_quadratic_filtr_a2;

	int night_35_quadratic_filtr_flag;
	double night_35_quadratic_filtr_sigma;
	double night_35_quadratic_filtr_a0;
	double night_35_quadratic_filtr_a1;
	double night_35_quadratic_filtr_a2;
};
...
int TFiltr::delta34Test( int scan, int j, double ang ) {
	if( ang > 3. ) {
		if( p.day_delta34_flag ) {
			if( p.day_34_quadratic_filtr_flag ){
				double t4 = in4_data[scan*cols+j]*in4_blk0.ka + in4_blk0.kb;
		...
		if( p.night_delta34_flag ) {
			if( p.night_34_quadratic_filtr_flag ){
				double t4 = in4_data[scan*cols+j]*in4_blk0.ka + in4_blk0.kb;
...
int TFiltr::delta35Test( int scan, int j, double ang ) {
	if( ang > 10. ) {
		if( p.day_delta35_flag ) {
			if( p.day_35_quadratic_filtr_flag ){
				double t4 = in4_data[scan*cols+j]*in4_blk0.ka + in4_blk0.kb;
		...
		if( p.night_delta35_flag ) {
			if( p.night_35_quadratic_filtr_flag ){
				double t4 = in4_data[scan*cols+j]*in4_blk0.ka + in4_blk0.kb;
...
int TFiltr::delta45Test( int scan, int j, double ang ) {
	if( ang > 3. ) {
		if( p.day_delta45_flag ) {
			if( p.day_45_quadratic_filtr_flag ){
				double t4 = in4_data[scan*cols+j]*in4_blk0.ka + in4_blk0.kb;
		...
		if( p.night_delta45_flag ) {
			if( p.night_45_quadratic_filtr_flag ){
				double t4 = in4_data[scan*cols+j]*in4_blk0.ka + in4_blk0.kb;
